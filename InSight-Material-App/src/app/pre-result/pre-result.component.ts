...
export class PreResultComponent implements OnInit {
  ...
  fetchIDs(con: any):Promise<any>{
    ...
    this.trial_User_userID = userId;  //sharedBy
    console.log("trial user_userid is "+ this.trial_User_userID);
	...
	console.log("entered getcreatedby function" +this.trial_User_userID);

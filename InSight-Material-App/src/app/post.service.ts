...
export class PostService {
    ...
    private url: string = this.appconfig.gateway_editor_url;
    ...
    postContent(content: string, tags: string, radio: number) 
    {
        ...
        return this.http.post("http://insight.blr.stackroute.in:5000/api/ContentDetails", JSON.stringify(this.content), options).catch(this.handleError);
